    ...
    <div className={classes.Meeting}>
      ...
      <div className={classes.Meeting__Info}>
        ...
        <p className={classes.Meeting__Info__Date}>
          <i className='fas fa-map-marker-alt' style={iconStyle}></i>May 20th
          2021 at 12:45 AM - 12:45 AM - EET (UTC+02:00)
        </p>
        <p className={classes.Meeting__Info__Type}>
          <i className='fas fa-link' style={iconStyle}></i>Online link
        </p>
        <p className={classes.Meeting__Info__Location}>
          <i className='fas fa-map-marker-alt' style={iconStyle}></i>Location
        </p>
